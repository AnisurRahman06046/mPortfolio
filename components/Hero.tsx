...
function Hero() {
  return (
    <div className="">
      ...
      <div className="h-screen absolute top-0 left-0 w-full dark:bg-black-100 bg-white  dark:bg-grid-white/[0.01] bg-grid-black/[0.2]  flex items-center justify-center">
